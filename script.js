...
const gameBoard = (() => {
    const gameBoardPiece = ['x', 'o'],
        gameBoardArray = [0, 'o', 'x', 3, 4, 'o', 6, 'x', 8],
...
const displayController = (() => {
    ...
    const minimax = (board = boardIndexArr, player) => {
        ...
        for (let i = 0; i < availSpots.length; i++) {
            ...
            board[availSpots.indexOf(availSpots[i])].textContent = player;
            ...
            board[availSpots.indexOf(availSpots[i])] = move.index;
            moves.push(move);
        }
